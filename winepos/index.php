...
<body style="background-image: linear-gradient(to bottom, #62c462, #00018f);">
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; color:#fff;"><center><font color="purple">W&S POS</font></center></font>
		<br>
