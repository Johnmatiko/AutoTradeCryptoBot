...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-group"></i> Purchase Summary Records
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="active">Purchase Summary Records</li>
			</ul>


<div style="margin-top: -19px; margin-bottom: 21px;">
<a  href="purchasingreport.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
<?php 
			include('../connect.php');
...
<input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter" placeholder="Search Record..." autocomplete="off" />
<a rel="facebox" href="addrecord.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Record</button></a><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo $row['expexted_date']; ?></td>
			<td><?php echo $row['due_date']; ?></td>
			<td><?php echo $row['order_ttl']; ?></td>
			<td>Kes. <?php echo $row['amnt_paid']; ?></td>
