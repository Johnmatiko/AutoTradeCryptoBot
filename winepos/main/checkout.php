...
<input type="hidden" name="amount1" value="<?php echo $_GET['total']; ?>" />
...
<input type="number" name="tax" placeholder="Tax" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/><br>

<?php
}
?><button class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i>Checkout</button>
</center>
</div>
</form>
</body>
